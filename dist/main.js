...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"fun_dom\": () => (/* binding */ fun_dom)\n/* harmony export */ });\n/* harmony import */ var _dom_id__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom_id */ \"./src/js/dom_id.js\");\n/* harmony import */ var _hero__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hero */ \"./src/js/hero.js\");\n\n\nconst fun_dom = {\n  get_id: {\n    complete: document.getElementById(\"button_complete\"),\n    login: document.getElementById(\"button_login\"),\n    back: document.getElementById(\"button_back\")\n  },\n\n  check() {\n    this.get_id.complete.addEventListener('click', event => {\n      const text = document.getElementById('text').value;\n      _hero__WEBPACK_IMPORTED_MODULE_1__.hero.array[_hero__WEBPACK_IMPORTED_MODULE_1__.hero.number] = new _hero__WEBPACK_IMPORTED_MODULE_1__.Hero(text, _hero__WEBPACK_IMPORTED_MODULE_1__.range, _hero__WEBPACK_IMPORTED_MODULE_1__.hero.number);\n      _hero__WEBPACK_IMPORTED_MODULE_1__.hero.array[_hero__WEBPACK_IMPORTED_MODULE_1__.hero.number].play();\n      _hero__WEBPACK_IMPORTED_MODULE_1__.hero.number++;\n    });\n    this.get_id.login.addEventListener('click', event => {\n      _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.akk.style.display = 'block';\n      _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.menu2.style.display = 'none';\n    });\n    this.get_id.back.addEventListener('click', event => {\n      _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.akk.style.display = 'none';\n      _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.menu2.style.display = 'block';\n    });\n  }\n\n};\n\n//# sourceURL=webpack://gunshot/./src/js/fun_dom.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"range\": () => (/* binding */ range),\n/* harmony export */   \"hero\": () => (/* binding */ hero),\n/* harmony export */   \"Hero\": () => (/* binding */ Hero)\n/* harmony export */ });\n/* harmony import */ var _dom_id__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dom_id */ \"./src/js/dom_id.js\");\n/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./player */ \"./src/js/player.js\");\n\n\nlet range = document.getElementById('range').value;\nconst hero = {\n  array: [],\n  number: 0,\n  index: 0,\n\n  checkScin() {\n    range = document.getElementById('range').value;\n    _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.image.src = 'images/' + range + '.png';\n  },\n\n  check() {\n    for (let i = 0; i < this.array.length; i++) {\n      this.array[i].check();\n    }\n  }\n\n};\nclass Hero {\n  constructor(name, scin, index) {\n    this.name = name;\n    this.scin = scin;\n    this.index = index;\n    this.player = null;\n    this.idName = '_' + this.name + '_' + this.index + '_';\n    this.cretae();\n  }\n\n  play() {\n    if (this.player === null) {\n      _player__WEBPACK_IMPORTED_MODULE_1__.player.array[_player__WEBPACK_IMPORTED_MODULE_1__.player.number] = new _player__WEBPACK_IMPORTED_MODULE_1__.Player(0, 0, this.scin, this.name, _player__WEBPACK_IMPORTED_MODULE_1__.player.number, 'zeck');\n      hero.index = _player__WEBPACK_IMPORTED_MODULE_1__.player.number;\n      _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.menu.style.display = 'none';\n      this.player = _player__WEBPACK_IMPORTED_MODULE_1__.player.number;\n      _player__WEBPACK_IMPORTED_MODULE_1__.player.number++;\n    } else {\n      hero.index = this.player;\n      _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.menu.style.display = 'none';\n    }\n  }\n\n  cretae() {\n    this.button = document.createElement(\"button\");\n    this.button.innerHTML = this.name;\n    this.button.id = this.idName;\n    _dom_id__WEBPACK_IMPORTED_MODULE_0__.dom_id.login.appendChild(this.button);\n    this.buttonID = document.getElementById(this.idName);\n  }\n\n  check() {\n    this.buttonID.addEventListener('click', event => {\n      this.play();\n    });\n  }\n\n}\n\n//# sourceURL=webpack://gunshot/./src/js/hero.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"localStorageReturn\": () => (/* binding */ localStorageReturn)\n/* harmony export */ });\n/* harmony import */ var _hero__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hero */ \"./src/js/hero.js\");\n\nconst raw = localStorage.getItem(\"gunshot_player\"),\n      person = JSON.parse(raw); //localStorage.clear();\n\nif (localStorage.getItem(\"gunshot_player\")) {\n  for (let i = 0; i < person.array.length; i++) {\n    _hero__WEBPACK_IMPORTED_MODULE_0__.hero.array[i] = new _hero__WEBPACK_IMPORTED_MODULE_0__.Hero(person.array[i].name, person.array[i].scin, person.array[i].index);\n  }\n\n  _hero__WEBPACK_IMPORTED_MODULE_0__.hero.number = person.number;\n}\n\nfunction localStorageReturn() {\n  let storage = {\n    array: [],\n    number: _hero__WEBPACK_IMPORTED_MODULE_0__.hero.number\n  };\n\n  for (let i = 0; i < _hero__WEBPACK_IMPORTED_MODULE_0__.hero.array.length; i++) {\n    storage.array[i] = _hero__WEBPACK_IMPORTED_MODULE_0__.hero.array[i];\n  }\n\n  localStorage.setItem(\"gunshot_player\", JSON.stringify(storage));\n}\n\n//# sourceURL=webpack://gunshot/./src/js/local.js?");
